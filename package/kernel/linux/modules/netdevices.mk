...
define KernelPackage/mdio-devres
  ...
  DEPENDS:=+kmod-libphy +(TARGET_armvirt||TARGET_bcm27xx_bcm2708||TARGET_tegra||TARGET_xburst):kmod-of-mdio
...
define KernelPackage/mdio-gpio
  ...
  DEPENDS:=+kmod-libphy @GPIO_SUPPORT +(TARGET_armvirt||TARGET_bcm27xx_bcm2708||TARGET_tegra||TARGET_xburst):kmod-of-mdio
  KCONFIG:= \
	CONFIG_MDIO_BITBANG \
	CONFIG_MDIO_GPIO
  FILES:= \
...
define KernelPackage/switch-rtl8366-smi
  ...
  DEPENDS:=@GPIO_SUPPORT +kmod-swconfig +(TARGET_armvirt||TARGET_bcm27xx_bcm2708||TARGET_tegra||TARGET_xburst):kmod-of-mdio
