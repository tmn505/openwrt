...
define Device/Default
  ...
  IMAGE/sysupgrade.bin = append-kernel | fit lzma external-static-with-rootfs | pad-rootfs | append-metadata
endef
...
define Device/NAND
  ...
  KERNEL_INITRAMFS = kernel-bin | lzma | \
	fit lzma with-initrd | pad-to 128k
  IMAGE/sysupgrade.bin = append-kernel | fit gzip external-static-with-rootfs | append-metadata
endef
